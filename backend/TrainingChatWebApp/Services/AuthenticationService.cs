...
{
    public static AuthenticationResult AuthenticateSession(string authorization)
    {
        ...
        var session = (connection.Query<Session>("""
    ...
    public static async Task<AuthenticationResult> AuthenticateSessionAsync(string authorization)
	{
		var authSplit = authorization.Split(' ');
		if (authSplit.Length != 2)
		{
